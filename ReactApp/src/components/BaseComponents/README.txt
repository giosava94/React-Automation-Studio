# RAS WIDGET CREATION GUIDE

This document will describe the logic to create a widget in React-Automation-Studio.

# LOGIC

The main components used to represent a Widget, a component connected to one or more PVs, are **ContextMenu, DataConnection, EpicsPV, LocalPV and Widget**. Let assume you want to create your custom component; you will create two components **CustomComponent** and **CustomContainer**. The following schema represents their interconnections.
