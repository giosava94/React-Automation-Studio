      ...
      marks = [
        {
          value: min,
          label:
            parseFloat(min).toFixed(this.props.precision) +
            " " +
            this.props.units,
        },
        {
          value: max,
          label:
            parseFloat(max).toFixed(this.props.precision) +
            " " +
            this.props.units,
        },
      ];
    ...
    return (
      <div className={this.props.classes.sliderDiv}>
        ...
        <Slider
          ...
          value={isFinite(this.props.value) ? this.props.value : 0}
          min={min}
          max={max}
          marks={marks}
...
function Container(props) {
  return <Widget component={SimpleSlider} {...props} />;
}
