...
function Container(props) {
  let xPVs = !Array.isArray(props.xPVs) ? [props.xPVs] : props.xPVs;
  let yPVs = !Array.isArray(props.yPVs) ? [props.yPVs] : props.yPVs;
  let pv = xPVs.concat(yPVs);
  return <Widget readOnly pv={pv} component={GraphXY} {...props} />;
}
